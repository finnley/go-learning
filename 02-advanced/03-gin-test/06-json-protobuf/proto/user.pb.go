...
type Teacher struct {
	...
	Name   string   `protobuf:"bytes,1,opt,name=name,proto3" json2struct:"name,omitempty"`
	Course []string `protobuf:"bytes,2,rep,name=course,proto3" json2struct:"course,omitempty"`
}
