...
// 请填写您的AccessKeyId。
var accessKeyId string = "LTAI4G4rF8UmhAV8cLaxBdNQ"

// 请填写您的AccessKeySecret。
var accessKeySecret string = "ZLdtsb1UteCp8JUjR2nfS1cNGcK4R5"

// host的格式为 bucketname.endpoint ，请替换为您的真实信息。
var host string = "http://go-shop-files.oss-cn-shanghai.aliyuncs.com"

// callbackUrl为 上传回调服务器的URL，请将下面的IP和Port配置为您自己的真实信息。
//var callbackUrl string = "http://88.88.88.88:8888"
var callbackUrl string = "http://e9qekdyxyp.51xd.pub"

// 用户上传文件时指定的前缀。
var upload_dir string = "user-dir-prefix/"
var expire_time int64 = 3000 // 签名超时时间 默认30s
...
// go run 02-advanced/oss-test/app/appserver.go 127.0.0.1 8082
// go run 02-advanced/oss-test/app/appserver.go 192.168.1.8 8082
func main() {
	strIPPort := ":8080"
	if len(os.Args) == 3 {
...
func responseSuccess(w http.ResponseWriter) {
	...
	strResponseBody := `{"Status":"OK", "url": "http://www.baidu.com"}`
